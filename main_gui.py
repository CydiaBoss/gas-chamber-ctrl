...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(":/icon/start.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.start_meas_btn.setIcon(icon2)
        ...
        self.stop_meas_btn.setIcon(icon3)
        ...
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap(":/icon/connect.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.action_Connect.setIcon(icon4)
